...
!(function(t, e) {
    ...
    var at = {
            ...
            findOne: function(t, e) {
                return (
                    void 0 === e && (e = document.documentElement), A.call(e, t)
                );
            },
                        ...
                        if (i && "radio" === i.type) {
                            ...
                            if (t) {
                                if (
                                    ...
                                    i.classList.contains(ut) ||
                                    n.classList.contains(ut)
                                )
                                    return;
            ...
            return (
                ...
                (n._addEventListeners = function() {
                    ...
                    this._config.keyboard &&
                        F.on(this._element, "keydown.coreui.carousel", function(
                            e
                        ) {
                            return t._keydown(e);
                        }),
                ...
                (n._addTouchEventListeners = function() {
                    var t = this,
                        e = function(e) {
                            t._pointerEvent && xt[e.pointerType.toUpperCase()]
                ...
                (n._getItemIndex = function(t) {
                    return (
                        (this._items =
                            t && t.parentNode
                                ? at.find(".carousel-item", t.parentNode)
                                : []),
                ...
                (n._setActiveIndicatorElement = function(t) {
                    if (this._indicatorsElement) {
                        for (
                            var e = at.find(".active", this._indicatorsElement),
                                n = 0;
                            n < e.length;
                            n++
                        )
    ...
    F.on(
        ...
        F.on(window, "load.coreui.carousel.data-api", function() {
            for (
                var t = at.find('[data-ride="carousel"]'), e = 0, n = t.length;
                e < n;
                e++
            )
                ...
                (n.class = function() {
                    (this._config.toggleClass = this._config.class),
                        this._element.getAttribute("responsive") &&
                            (this._config.responsive = this._element.getAttribute(
                                "responsive"
                            )),
                        this.toggle();
                }),
    ...
    F.on(document, "click.coreui.class-toggler.data-api", Yt, function(t) {
        ...
        e.classList.contains("c-class-toggler") || (e = e.closest(Yt)),
            "undefined" != typeof e.dataset.addClass &&
                Xt.classTogglerInterface(e, "add"),
            "undefined" != typeof e.dataset.removeClass &&
                Xt.classTogglerInterface(e, "remove"),
            "undefined" != typeof e.dataset.toggleClass &&
                Xt.classTogglerInterface(e, "toggle"),
            "undefined" != typeof e.dataset.class &&
                Xt.classTogglerInterface(e, "class");
    });
    var Bt = L();
    if (Bt) {
        var Ut = Bt.fn[It];
            ...
            return (
                ...
                (n.show = function() {
                    ...
                    if (
                        ...
                        if (
                            !F.trigger(this._element, "show.coreui.collapse")
                                .defaultPrevented
                        ) {
                            n &&
                ...
                (n.hide = function() {
                    ...
                    if (
                        !this._isTransitioning &&
                        this._element.classList.contains(zt) &&
                        !F.trigger(this._element, "hide.coreui.collapse")
                            .defaultPrevented
                    ) {
                ...
                (n._getConfig = function(t) {
                    return (
                        ((t = o(o({}, Ft), t)).toggle = Boolean(t.toggle)),
                        _(qt, t, Vt),
                        t
                    );
                }),
                ...
                (n._getParent = function() {
                    ...
                    return (
                        at.find(n, e).forEach(function(e) {
                            var n = d(e);
    ...
    function Ee(t, e) {
        ...
        if (
            i &&
            ((n = i) instanceof ve(n).ShadowRoot || n instanceof ShadowRoot)
        ) {
            var o = e;
            do {
    ...
    function Oe(t) {
        return "html" === me(t)
            ? t
            : t.assignedSlot || t.parentNode || t.host || ke(t);
    }
    function Ce(t) {
    ...
    function Se(t) {
        for (
            var e = ve(t), n = Ce(t);
            n && Te(n) && "static" === Le(n).position;

        )
            n = Ce(n);
        return n && "body" === me(n) && "static" === Le(n).position
            ? e
            : n ||
                  (function(t) {
                      for (
                          var e = Oe(t);
                          be(e) && ["html", "body"].indexOf(me(e)) < 0;
    ...
    function Ie(t) {
        ...
        var _,
            b = Object.assign({ position: s }, l && Ne);
        return a
            ? Object.assign(
                  Object.assign({}, b),
                  {},
                ...
                (("body" !== me(e) || Ue(o)) &&
                    (a =
                        (i = e) !== ve(i) && be(i)
                            ...
                            : Xe(i)),
                be(e)
                    ? (((l = Ye(e)).x += e.clientLeft), (l.y += e.clientTop))
                    : o && (l.x = Be(o))),
            {
                ...
                },
                {
                    ...
                    effect: function(t) {
                        ...
                        null != r &&
                            ...
                            Ee(e.elements.popper, r) &&
                            ((e.elements.arrow = r),
                            (e.modifiersData[i + "#persistent"] = {
                                padding: De(
                                    "number" != typeof a ? a : je(a, le)
                                )
                            }));
                    },
                    requires: ["popperOffsets"],
            ...
            return (
                ...
                (n.hide = function() {
                    if (
                        ...
                        var e = t.getParentFromElement(this._element),
                            n = { relatedTarget: this._element };
                        F.trigger(e, mn, n).defaultPrevented ||
                ...
                (n._getPlacement = function() {
                    ...
                    return (
                        t.classList.contains("dropup")
                            ? ((e = "top-start"),
                              this._menu.classList.contains(En) &&
                                  (e = "top-end"))
                ...
                (t.clearMenus = function(e) {
                    if (
                        ...
                        for (
                            var n = at.find(Ln), i = 0, o = n.length;
                            i < o;
                            i++
                        ) {
            ...
            return (
                ...
                (n.hide = function(t) {
                    ...
                    if (
                        ...
                        !F.trigger(this._element, "hide.coreui.modal")
                            .defaultPrevented
                    ) {
                        this._isShown = !1;
                ...
                (n._setEscapeEvent = function() {
                    var t = this;
                    this._isShown
                        ? F.on(this._element, Xn, function(e) {
                              t._config.keyboard && e.key === Nn
                ...
                (t.jQueryInterface = function(e, n) {
                    return this.each(function() {
                        var i = O(this, Dn),
                            r = o(
                                o(o({}, In), bt.getDataAttributes(this)),
                                "object" == typeof e && e ? e : {}
                            );
                        ...
                        (function(t, e) {
                            ...
                            if (-1 !== e.indexOf(n))
                                return (
                                    -1 === Jn.indexOf(n) ||
                                    Boolean(
                                        t.nodeValue.match(Zn) ||
                                            t.nodeValue.match(ti)
                                    )
                                );
                            for (
            ...
            return (
                ...
                (n._getContainer = function() {
                    return !1 === this.config.container
                        ...
                        : at.findOne(this.config.container);
                }),
                    ...
                    this.config.trigger.split(" ").forEach(function(e) {
                        if ("click" === e)
                            ...
                            F.on(t.element, n, t.config.selector, function(e) {
                                ...
                                F.on(t.element, i, t.config.selector, function(
                                    e
                                ) {
                                    return t._leave(e);
                                });
                ...
                (n._enter = function(t, e) {
                    ...
                    (e = e || O(t.delegateTarget, n)) ||
                        ...
                        t &&
                            (e._activeTrigger[
                                "focusin" === t.type ? vi : mi
                            ] = !0),
                        e.getTipElement().classList.contains(di) ||
                        e._hoverState === pi
                            ? (e._hoverState = pi)
        ...
        Si = (function(t) {
            ...
            return (
                ...
                (r.setContent = function() {
                    var t = this.getTipElement();
                    this.setElementContent(
                        at.findOne(".popover-header", t),
                        this.getTitle()
                    );
                    var e = this._getContent();
                    "function" == typeof e && (e = e.call(this.element)),
                        this.setElementContent(
                            at.findOne(".popover-body", t),
                            e
                        ),
    ...
    function ao(t, e, n, i, o) {
        ...
        !(function(t, e, n, i, o) {
            ...
            e &&
                (f.dispatchEvent(so("ps-scroll-" + l)),
                e < 0
                    ? f.dispatchEvent(so("ps-scroll-" + c))
                    : e > 0 && f.dispatchEvent(so("ps-scroll-" + u)),
                i &&
                    (function(t, e) {
                        eo(t, e), no(t, e);
                    })(t, l));
            t.reach[l] &&
                (e || o) &&
                f.dispatchEvent(so("ps-" + l + "-reach-" + t.reach[l]));
        })(t, n, r, i, o);
    }
    function lo(t) {
    ...
    function uo(t) {
        ...
        (t.containerWidth = Math.ceil(i.width)),
            ...
            e.contains(t.scrollbarXRail) ||
                (Ki(e, Ji.rail("x")).forEach(function(t) {
                    return zi(t);
                }),
                e.appendChild(t.scrollbarXRail)),
            e.contains(t.scrollbarYRail) ||
                (Ki(e, Ji.rail("y")).forEach(function(t) {
                    return zi(t);
                }),
            ...
            t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
                ? ((t.scrollbarXActive = !0),
                  ...
                  (t.scrollbarXWidth = fo(
                      t,
                      lo((t.railXWidth * t.containerWidth) / t.contentWidth)
                  )),
                  (t.scrollbarXLeft = lo(
            ...
            t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
                ? ((t.scrollbarYActive = !0),
                  ...
                  (t.scrollbarYHeight = fo(
                      t,
                      lo((t.railYHeight * t.containerHeight) / t.contentHeight)
                  )),
                  (t.scrollbarYTop = lo(
            ...
            t.scrollbarXActive
                ? e.classList.add(Zi.active("x"))
                : (e.classList.remove(Zi.active("x")),
                  (t.scrollbarXWidth = 0),
                  (t.scrollbarXLeft = 0),
                  (e.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0)),
            t.scrollbarYActive
                ? e.classList.add(Zi.active("y"))
                : (e.classList.remove(Zi.active("y")),
            ...
            keyboard: function(t) {
                ...
                t.event.bind(t.ownerDocument, "keydown", function(n) {
                    if (
                        ...
                        (Vi(e, ":hover") ||
                            Vi(t.scrollbarX, ":focus") ||
                            Vi(t.scrollbarY, ":focus"))
                    ) {
                        var i,
                        ...
                        if (o) {
                            ...
                            if (
                                Vi((i = o), "input,[contenteditable]") ||
                                Vi(i, "select,[contenteditable]") ||
                                Vi(i, "textarea,[contenteditable]") ||
                                Vi(i, "button,[contenteditable]")
                            )
                                return;
                        }
                        var r = 0,
            ...
            (this.scrollbarXBottom = parseInt(l.bottom, 10)),
                isNaN(this.scrollbarXBottom)
                    ? ((this.isScrollbarXUsingBottom = !1),
                      (this.scrollbarXTop = lo(l.top)))
                    : (this.isScrollbarXUsingBottom = !0),
                (this.railBorderXWidth =
                    lo(l.borderLeftWidth) + lo(l.borderRightWidth)),
                qi(this.scrollbarXRail, { display: "block" }),
                (this.railXMarginWidth = lo(l.marginLeft) + lo(l.marginRight)),
                qi(this.scrollbarXRail, { display: "" }),
                ...
                (this.scrollbarYOuterWidth = this.isRtl
                    ? (function(t) {
                          ...
                          return (
                              ...
                              lo(e.paddingLeft) +
                              lo(e.paddingRight) +
                              lo(e.borderLeftWidth) +
                              lo(e.borderRightWidth)
                          );
                      })(this.scrollbarY)
                    : null),
                (this.railBorderYWidth =
                    lo(c.borderTopWidth) + lo(c.borderBottomWidth)),
                qi(this.scrollbarYRail, { display: "block" }),
                (this.railYMarginHeight = lo(c.marginTop) + lo(c.marginBottom)),
                qi(this.scrollbarYRail, { display: "" }),
    ...
    (go.prototype.update = function() {
        this.isAlive &&
            ...
            (this.railXMarginWidth =
                lo(Ui(this.scrollbarXRail).marginLeft) +
                lo(Ui(this.scrollbarXRail).marginRight)),
            (this.railYMarginHeight =
                lo(Ui(this.scrollbarYRail).marginTop) +
                lo(Ui(this.scrollbarYRail).marginBottom)),
            qi(this.scrollbarXRail, { display: "none" }),
            qi(this.scrollbarYRail, { display: "none" }),
            uo(this),
            ao(this, "top", 0, !1, !0),
            ao(this, "left", 0, !1, !0),
            qi(this.scrollbarXRail, { display: "" }),
    ...
    var mo = "sidebar",
        ...
        Do = (function() {
            ...
            return (
                ...
                (n.minimize = function() {
                    this._isMobile() ||
                        (this._addClassName(Lo),
                        (this._minimize = !0),
                        this._psDestroy());
                }),
                (n.unfoldable = function() {
                    this._isMobile() ||
                        (this._addClassName(To), (this._unfoldable = !0));
                }),
                (n.reset = function() {
                ...
                (n._toggleDropdown = function(t, e) {
                    ...
                    "undefined" != typeof i.dropdownAccordion &&
                        (_o.dropdownAccordion = JSON.parse(
                            i.dropdownAccordion
                        )),
                        !0 === _o.dropdownAccordion &&
                ...
                (n._psInit = function() {
                    this._element.querySelector(Ao) &&
                        !this._isIOS() &&
                        (this._ps = new go(this._element.querySelector(Ao), {
                            suppressScrollX: !0,
                            wheelPropagation: !1
                        }));
                }),
                ...
                (n._setActiveLink = function() {
                    var t = this;
                    Array.from(this._element.querySelectorAll(So)).forEach(
                        function(e) {
                            ...
                            "undefined" != typeof i.activeLinksExact &&
                                (_o.activeLinksExact = JSON.parse(
                                    i.activeLinksExact
                                )),
                                _o.activeLinksExact &&
                                    e.href === n &&
                                    (e.classList.add(yo),
                                    Array.from(t._getParents(e, Co)).forEach(
                                        function(t) {
                                            t.classList.add(Eo);
                                        }
                                    )),
                ...
                (n._addEventListeners = function() {
                    ...
                    this._mobile && this._open && this._addClickOutListener(),
                        ...
                        F.on(this._element, "classtoggle", function(e) {
                            if (
                                (e.detail.className === Lo &&
                                    (t._element.classList.contains(Lo)
                                        ? t.minimize()
                                        : t.reset()),
                                e.detail.className === To &&
                                    (t._element.classList.contains(To)
                                        ? t.unfoldable()
                                        : t.reset()),
                                "undefined" !=
                                    typeof Object.keys(_o.breakpoints).find(
                                        function(t) {
                                            return (
                                                _o.breakpoints[t] ===
                                                e.detail.className
                                ...
                                var n = e.detail.className,
                                    i = Object.keys(_o.breakpoints).find(
                                        function(t) {
            ...
            return (
                ...
                (n._transitionComplete = function(t, e, n) {
                    ...
                    t.parentNode &&
                        ...
                        (t.closest(".dropdown") &&
                            at.find(".dropdown-toggle").forEach(function(t) {
        ...
        ir = (function() {
            ...
            return (
                (n.show = function() {
                    var t = this;
                    if (
                        !F.trigger(this._element, "show.coreui.toast")
                            .defaultPrevented
                    ) {
                        this._clearTimeout(),
                ...
                (n.hide = function() {
                    ...
                    if (
                        ...
                        !F.trigger(this._element, "hide.coreui.toast")
                            .defaultPrevented
                    ) {
                        var e = function() {
                ...
                (n._getConfig = function(t) {
                    return (
                        (t = o(
                            o(o({}, nr), bt.getDataAttributes(this._element)),
                            "object" == typeof t && t ? t : {}
                        )),
            ...
            (Array.from =
                ...
                function(t) {
                    ...
                    for (
                        var r,
                            s = Fo(n.length),
                            a = qo(e) ? Object(new e(s)) : new Array(s),
                            l = 0;
                        l < s;
