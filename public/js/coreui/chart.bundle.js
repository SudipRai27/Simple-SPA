     ...
     */ (function(global, factory) {
        ...
        helpers$1.extend(DatasetController.prototype, {
            ...
            createMetaDataset: function() {
                ...
                return (
                    type &&
                    new type({ _chart: me.chart, _datasetIndex: me.index })
                );
            },
        ...
        function boundingRects(vm) {
            ...
            return {
                outer: { x: bounds.left, y: bounds.top, w: width, h: height },
                inner: {
        ...
        core_defaults._set("global", {
            datasets: { scatter: { showLine: false } }
        });
        ...
        var defaultConfig$1 = {
            position: "left",
            ticks: { callback: core_ticks.formatters.linear }
        };
        var DEFAULT_MIN = 0;
        var DEFAULT_MAX = 1;
        ...
        var defaultConfig$2 = {
            position: "left",
            ticks: { callback: core_ticks.formatters.logarithmic }
        };
